...
import { Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Divider, IconButton, ImageList, ImageListItem, ImageListItemBar, Input, Typography } from "@mui/material";
...
export function AddPhotoFast({ open, onClose, plants }) {
  ...
  return(
    ...
    <Typography variant="caption" color="error">{error.data.message}</Typography></>}
    </DialogContent>
    <DialogActions>
